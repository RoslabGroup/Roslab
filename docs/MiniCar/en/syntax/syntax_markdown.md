...
This article is a document written using `Markdown`, using the page effect generated by `teedoc`, see [here](https://github.com/teedoc/teedoc.github.io/blob/main/docs/ MiniCar/zh/syntax/syntax_markdown.md)
...
Create a folder or file in the directory corresponding to `config.json`, such as `MiniCar/zh/syntax/syntax_markdown.md` (`README.md` will eventually generate `index.html`), and then write the content:
